...
+function (a) {
            ...
            if (b.length) {
                ...
                "radio" == c.prop("type") ? (c.prop("checked") && (a = !1),
                    ...
                    this.$element.addClass("active")) : "checkbox" == c.prop("type") && (c.prop("checked") !== this.$element.hasClass("active") && (a = !1),
                        this.$element.toggleClass("active")), c.prop("checked", this.$element.hasClass("active")), a && c.trigger("change")
            } else
    ...
    a.fn.button = b, a.fn.button.Constructor = c, a.fn.button.noConflict = function () {
        ...
        a(document).on
            ("click.bs.button.data-api", '[data-toggle^="button"]', function (c) {
                var d = a(c.target);
    ...
    var c = function (b, c) {
        this.$element = a(b),
            ...
            this.options = c,
            this.paused = null, this.sliding = null, this.interval = null,
            this.$active = null,
            this.$items = null,
    ...
    c.VERSION = "3.3.6", c.TRANSITION_DURATION = 600,
        ...
        c.prototype.slide = function (b, d) {
            ...
            if (this.$element.trigger(k), !k.isDefaultPrevented()) {
                if (this.sliding = !0, g && this.pause(),
    ...
    var d = a.fn.carousel;
    a.fn.carousel = b,
        a.fn.carousel.Constructor = c, a.fn.carousel.noConflict = function () {
    ...
    [data-toggle="collapse"][data-target="#' + b.id + '"]'),
            ...
            this.options.parent ? this.$parent = this.getParent() : this.addAriaAndCollapsedClass
                (
    ...
    function d(b) {
        return this.each(function () {
            ...
            d || c.data("bs.dropdown",
                d = new g(this)), "string" == typeof b && d[b].call(c)
        })
    }
        ...
        if (!e.is(".disabled, :disabled")) {
            ...
            if (c(), !g) {
                "ontouchstart" in document.documentElement && !f.closest(".navbar-nav").length && a(
                    document.createElement("div")).addClass("dropdown-backdrop").insertAfter(a(this)).on("click", c);
    ...
    a.fn.dropdown = d,
        ...
        a.fn.dropdown.noConflict = function () {
            ...
            f, g.prototype.toggle).on("keydown.bs.dropdown.data-api",
                f, g.prototype.keydown).on("keydown.bs.dropdown.data-api", ".dropdown-menu", g.prototype.keydown)
}
    (jQuery), +function (a) {
        "use strict";
        function b(b, d) {
            return this.each(function () {
                ...
                f || e.data("bs.modal",
                    f = new c(this, g)), "string" == typeof b ? f[b](d) : g.show && f.show(d)
            })
        }
        var c = function (b, c) {
        ...
        c.VERSION = "3.3.6",
            ...
            c.prototype.show = function (b) {
                        ...
                        this.$dialog.on("mousedown.dismiss.bs.modal",
                            function () {
                                ...
                                d.$element.parent().length || d.$element.appendTo(d.$body),
                                    ...
                                    d.adjustDialog(), e && d.$element[0].offsetWidth,
                ...
                b && b.preventDefault(), b = a.Event("hide.bs.modal"),
                    this.$element.trigger(b),
                    this.isShown && !b.isDefaultPrevented() && (this.isShown = !1,
                        this.escape(),
                        this.resize(), a(document).off("focusin.bs.modal"),
            ...
            c.prototype.removeBackdrop = function () {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    if (
                        ...
                        ).addClass("modal-backdrop " + e).appendTo(this.$body),
